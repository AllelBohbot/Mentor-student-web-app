...
const CodeEditor = () => {
    ...
    useEffect(() => {
        ...
        setSocket(newSocket);
        newSocket.emit('setExpectedCode', {expectedCode:'function Fibonacci5(){let a = 0, b = 1;for (let i = 0; i < 5; i++) {console.log(a);let temp = a + b;a = b;b = temp;};'})
    ...
    return (
        <>
            <Head>
                <title>Collaborate coding | Fibonacci 5</title>
            </Head>
            <div>
                <h1>Fibonacci 5</h1>
                {userType === 'writer' && (
